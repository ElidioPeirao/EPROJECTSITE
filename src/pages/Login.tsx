        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="h-48 overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1581092583537-20d51b4b4f1b?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwxfHxtZWNoYW5pY2FsJTIwZW5naW5lZXJpbmclMjB0b29scyUyMGJsdWVwcmludHxlbnwwfHx8fDE3NDYxMzQ0NDl8MA&ixlib=rb-4.0.3&fit=fillmax&h=600&w=800"
