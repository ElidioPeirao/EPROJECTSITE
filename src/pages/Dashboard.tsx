...
import { ExternalLink, Settings, Tag } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const { user, tools, usePromoCode } = useUser();
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="mt-8">
          <div className="relative h-64 rounded-xl overflow-hidden">
            <img
              src="https://images.unsplash.com/photo-1581092583537-20d51b4b4f1b?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwxfHxtZWNoYW5pY2FsJTIwZW5naW5lZXJpbmclMjBibHVlcHJpbnQlMjB0b29sc3xlbnwwfHx8fDE3NDYxMzYxNTV8MA&ixlib=rb-4.0.3&fit=fillmax&h=600&w=800"
